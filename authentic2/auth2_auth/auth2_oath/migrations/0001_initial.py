...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('auth2_oath_oathtotpsecret', (
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='oath_totp_secret', unique=True, primary_key=True, to=orm['auth.User'])),
    ...
    models = {
        ...
        'auth2_oath.oathtotpsecret': {
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'oath_totp_secret'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['auth.User']"})
        },
